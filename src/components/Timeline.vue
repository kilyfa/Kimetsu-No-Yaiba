    ...
    <ol class="relative border-s border-gray-200 dark:border-gray-700">
      <li class="mb-10 ms-6">
        ...
        <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
          Flowbite Application UI v2.0.0 <span class="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span>
        </h3>
...
export default {
  ...
  data() {
    return {
      events: [
        { id: 1, date: "2024-01-01", text: "Event 1" },
        { id: 2, date: "2024-02-15", text: "Event 2" },
        { id: 3, date: "2024-03-20", text: "Event 3" },
        { id: 4, date: "2024-04-25", text: "Event 4" },
      ],
    };
  },
};
